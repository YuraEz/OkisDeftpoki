...
public class Item : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
           if(selectText) selectText.text = "PICK";
            if (selectTextbg) selectTextbg.text = "PICK";
            if (mark && !donateItem) mark.SetActive(false);
        }
    }
    ...
    public void SelectItem()
    {
        ...
        if (selectText) selectText.text = "PICKED";
        if (selectTextbg) selectTextbg.text = "PICKED";
        if (mark && !donateItem) mark.SetActive(true);
    }
